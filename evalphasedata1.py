...
#%% micro phase dataset
startime = time.time()
gt = cv2.imread('gt_microbtrakerlabelgt.tif',cv2.CV_LOAD_IMAGE_UNCHANGED)
gt = cb.removeBoundaryLabel(gt)
gt = cb.labelDilation(gt,5)

cbaout = cv2.imread('cba_microtrackeroutimg.tif',cv2.CV_LOAD_IMAGE_UNCHANGED)
cbaout = cb.removeBoundaryLabel(cbaout)
cbaout = cb.labelDilation(cbaout,3)


cbafilt = cv2.imread('cba_microtrackerfilterout.tif',cv2.CV_LOAD_IMAGE_UNCHANGED)
cbafilt = cb.removeBoundaryLabel(cbafilt)
cbafilt = cb.labelDilation(cbafilt,3)

cbasmooth = cv2.imread('cba_microtrackersmoothout.tif',cv2.CV_LOAD_IMAGE_UNCHANGED)
cbasmooth = cb.removeBoundaryLabel(cbasmooth)
cbasmooth = cb.labelDilation(cbasmooth,3)

mamle = cv2.imread('mamle_microb.tif',cv2.CV_LOAD_IMAGE_UNCHANGED)
mamle = cb.removeBoundaryLabel(mamle)
mamle = cb.labelDilation(mamle,3)

#%%

plotloc = ''

matfile = sio.loadmat('phase1.mat')
...
line2, = plt.plot(xval, ft2, label='CBA + filtering',color = 'r', linestyle = '--',linewidth = LINEWIDTH)
line3, = plt.plot(xval, ft3, label='CBA + filtering + smoothing',color = 'g', linestyle = ':' ,marker = '',linewidth = LINEWIDTH)
line4, = plt.plot(xval, ft4, label='Microbetracker',color = 'b', linestyle = '-',linewidth = LINEWIDTH)
line5, = plt.plot(xval, ft5, label='MAMLE',color = 'y', linestyle = '-',linewidth = LINEWIDTH)
...
plt.savefig(plotloc+'phasdat1fscorecumul.png',bbox_inches='tight')
...
#plt.figure()#, plt.plot(xval, ft1, label='outimg','')#, xval, ft2, 'b', xval, ft3, 'r', xval, ft4, 'g'),plt.title('F-score Elf phase'),plt.legend(('line1','line2','line3','line4'),('outimg','filterout','smoothout','microbetracker')),plt.show()
#line1, = plt.plot(xval, r1, label='CBA',color = 'k',linewidth = LINEWIDTH)
#line2, = plt.plot(xval, r2, label='CBA + filtering',color = 'r', linestyle = '--',linewidth = LINEWIDTH)
#line3, = plt.plot(xval, r3, label='CBA + filtering + smoothing',color = 'g', linestyle = ':' ,marker = '',linewidth = LINEWIDTH)
#line4, = plt.plot(xval, r4, label='Microbetracker',color = 'b', linestyle = '-',linewidth = LINEWIDTH)
#line5, = plt.plot(xval, r5, label='MAMLE',color = 'y', linestyle = '-',linewidth = LINEWIDTH)
#
#plt.xlabel('Recall phase data 1', fontsize=FONTSIZE)#,plt.ylabel('Number of cells', fontsize=FONTSIZE)
##plt.legend(handler_map={line1: HandlerLine2D(numpoints=16)})
##plt.show()
#frame=plt.gca()
#frame.axes.get_xaxis().set_visible(False)
#frame.axes.get_yaxis().set_visible(False)
#plt.savefig(plotloc+'phasdat1recall.png',bbox_inches='tight')
...
#plt.figure()#, plt.plot(xval, ft1, label='outimg','')#, xval, ft2, 'b', xval, ft3, 'r', xval, ft4, 'g'),plt.title('F-score Elf phase'),plt.legend(('line1','line2','line3','line4'),('outimg','filterout','smoothout','microbetracker')),plt.show()
#line1, = plt.plot(xval, p1, label='CBA',color = 'k',linewidth = LINEWIDTH)
#line2, = plt.plot(xval, p2, label='CBA + filtering',color = 'r', linestyle = '--',linewidth = LINEWIDTH)
#line3, = plt.plot(xval, p3, label='CBA + filtering + smoothing',color = 'g', linestyle = ':' ,marker = '',linewidth = LINEWIDTH)
#line4, = plt.plot(xval, p4, label='Microbetracker',color = 'b', linestyle = '-',linewidth = LINEWIDTH)
#line5, = plt.plot(xval, p5, label='MAMLE',color = 'y', linestyle = '-',linewidth = LINEWIDTH)
#
#plt.xlabel('Precision phase data 1', fontsize=FONTSIZE)#,plt.ylabel('Number of cells', fontsize=FONTSIZE)
##plt.legend(handler_map={line1: HandlerLine2D(numpoints=16)})
##plt.show()
#frame=plt.gca()
#frame.axes.get_xaxis().set_visible(False)
#frame.axes.get_yaxis().set_visible(False)
#plt.savefig(plotloc+'phasdat1prec.png',bbox_inches='tight')
...
#plt.figure()#, plt.plot(xval, ft1, label='outimg','')#, xval, ft2, 'b', xval, ft3, 'r', xval, ft4, 'g'),plt.title('F-score Elf phase'),plt.legend(('line1','line2','line3','line4'),('outimg','filterout','smoothout','microbetracker')),plt.show()
#line1, = plt.plot(xval, d1, label='CBA',color = 'k',linewidth = LINEWIDTH)
#line2, = plt.plot(xval, d2, label='CBA + filtering',color = 'r', linestyle = '--',linewidth = LINEWIDTH)
#line3, = plt.plot(xval, d3, label='CBA + filtering + smoothing',color = 'g', linestyle = ':' ,marker = '',linewidth = LINEWIDTH)
#line4, = plt.plot(xval, d4, label='Microbetracker',color = 'b', linestyle = '-',linewidth = LINEWIDTH)
#line5, = plt.plot(xval, d5, label='MAMLE',color = 'y', linestyle = '-',linewidth = LINEWIDTH)
#
#plt.xlabel('F-score phase data 1', fontsize=FONTSIZE)#,plt.ylabel('Number of cells', fontsize=FONTSIZE)
##plt.legend(handler_map={line1: HandlerLine2D(numpoints=16)})
##plt.show()
#frame=plt.gca()
#frame.axes.get_xaxis().set_visible(False)
#frame.axes.get_yaxis().set_visible(False)
#plt.savefig(plotloc+'phasdat1fscore.png',bbox_inches='tight')
...
microare =  sio.loadmat('/Users/sajithks/Documents/project_cell_tracking/processed/result_comparisons/segmentation/others/microbetrackerout/areamicrophase.mat') 
...
plt.xticks(np.arange(0,1400,500))
plt.tick_params(axis='both', which='major', labelsize=30)
#frame.axes.get_xaxis().set_visible(False)
#frame.axes.get_yaxis().set_visible(False)
plt.savefig(plotloc+'phasdat1areadist.png',bbox_inches='tight')
